...
class _TeacherPageState extends State<TeacherPage> {
  ...
  void initState() {
    ...
    if (widget.teacher != null) {
      ...
      _bornDateController.text =
          SelectDate().formatTextDate(date: selectedDate);
    }
  }
                    ...
                    IconButton(
                      ...
                      onPressed: () async {
                        await SelectDate().selectDate(
                          context: context,
                          actualDate: selectedDate).then((value) {
                            setState(() {
                              selectedDate = value!;
                              _bornDateController.text = SelectDate()
                                  .formatTextDate(date: selectedDate);
                            });
                          },
                        );
                      },
  ...
  void _save() {
    if (_formKey.currentState!.validate()) {
      if (widget.teacher == null ||
        ...
        _teacherHelper.update(widget.teacher!);
      }
  ...
  void _deleteTeacher() {
    _teacherHelper.delete(widget.teacher!);
    Navigator.pop(context);
    Navigator.pop(context);
  }
}
